...
$conn = db();
$stats = [];
$stats['revenue'] = $conn->query("SELECT COALESCE(SUM(total_price), 0) AS total FROM bookings WHERE booking_status = 'confirmed' OR payment_status = 'berhasil'")->fetch_assoc()['total'];
    ...
    <main class="admin-main">
        <div class="container admin-content">
            <header class="admin-header">
                ...
                <p>Ringkasan pendapatan dan jumlah booking.</p>
            </header>
            <div class="cards">
                <div class="card app-card">
                    <div class="card-label">Total Pendapatan</div>
                    <strong>Rp <?php echo number_format($stats['revenue'], 0, ',', '.'); ?></strong>
                </div>
                <div class="card app-card">
                    <div class="card-label">Jumlah Booking</div>
